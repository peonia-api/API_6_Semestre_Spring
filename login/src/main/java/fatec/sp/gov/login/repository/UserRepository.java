...
public interface UserRepository extends JpaRepository<User, UUID> {  // Alterado para UUID
    ...
    // Removido os métodos com assinaturas incorretas utilizando UUID onde deveriam usar comparações diretas
}
